...
HD_PWD='C:/Users/eliof/Desktop/Esercizi ASDI/Esercizio2.1/Esercizio2.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comb_net.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comb_net.tcl
