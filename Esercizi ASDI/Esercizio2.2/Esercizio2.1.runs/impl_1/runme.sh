...
HD_PWD='C:/Users/eliof/Desktop/Esercizi ASDI/Esercizio2.1/Esercizio2.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comb_net.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comb_net.tcl -notrace
