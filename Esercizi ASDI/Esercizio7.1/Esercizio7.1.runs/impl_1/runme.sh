...
HD_PWD='C:/Users/eliof/Desktop/Esercizi ASDI/Esercizio7.1/Esercizio7.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Booth_on_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Booth_on_board.tcl -notrace
