...
HD_PWD='C:/Users/eliof/Desktop/Esercizi ASDI/Esercizio7.1/Esercizio7.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Booth_on_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Booth_on_board.tcl
