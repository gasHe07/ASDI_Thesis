...
HD_PWD='C:/Users/eliof/Desktop/Esercizi ASDI/Esercizio_6.1/Esercizio_6.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log on_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source on_board.tcl
