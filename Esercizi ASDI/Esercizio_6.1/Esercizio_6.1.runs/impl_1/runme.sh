...
HD_PWD='C:/Users/eliof/Desktop/Esercizi ASDI/Esercizio_6.1/Esercizio_6.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log on_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source on_board.tcl -notrace
